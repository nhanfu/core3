...
- The PRD asks for automated interaction coverage for every control. The current browser audit proves route mounting and error-free rendering; it does not yet exercise every filter, editor, chooser, export, sort, pagination, or workflow transition.
