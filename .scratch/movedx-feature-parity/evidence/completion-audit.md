...
- A disposable fresh-database workflow audit completes 29 named transitions, 6 invalid-transition rejection checks, and 3 invalid-payload validation checks across workflow, builder, and chat action boundaries.
