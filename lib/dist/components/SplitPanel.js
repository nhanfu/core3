...
export class SplitPanel extends BaseComponent {
    constructor(id, leftComp, rightComp, opts = {}) {
        ...
        this.opts = opts;
        if (leftComp) {
            leftComp.parent = this;
            this.children.push(leftComp);
        }
        if (rightComp) {
            rightComp.parent = this;
            this.children.push(rightComp);
        }
    }
    draw(container) {
        ...
        if (this.leftComp)
            this.leftComp.mount(html.take(grid).div.getContext());
        if (this.rightComp)
            this.rightComp.mount(html.take(grid).div.getContext());
    }
}
