...
const FIELD_KEYS = new Set(['field', 'label', 'type', 'required', 'options', 'options_source', 'default', 'tokens']);
...
const COMPONENT_KEYS = new Map<string, Set<string>>([
  ...
  ['DataGrid', new Set(['type', 'source', 'page_size', 'page_size_options', 'row_key', 'row_numbers', 'empty_state', 'columns', 'selectable', 'column_chooser', 'reorder'])],
