...
const COMPONENT_KEYS = new Map<string, Set<string>>([
  ...
  ['ListView', new Set(['type', 'source', 'variant', 'create_action', 'create_label', 'search', 'date_range', 'filter_sources', 'filters', 'actions', 'labels', 'views', 'page_size', 'row_key', 'empty_state', 'columns', 'selectable', 'column_chooser', 'row_open_action', 'row_actions'])],
