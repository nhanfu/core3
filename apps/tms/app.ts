...
const ROUTE_TITLES: Record<string, string> = {
  ...
  '/org/own-company': 'Công ty chủ quản', '/org/branches': 'Chi nhánh', '/org/departments/detail': 'Chi tiết phòng ban', '/org/roles/detail': 'Chi tiết vai trò', '/org/users/detail': 'Chi tiết người dùng',
