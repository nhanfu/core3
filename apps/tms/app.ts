...
const ROUTES: Record<string, string | (() => Promise<any>)> = {
  ...
  '/hr/employees': 'employees', '/hr/employees/detail': 'employee-detail',
...
const ROUTE_TITLES: Record<string, string> = {
  ...
  '/hr/employees': 'Nhân viên', '/hr/employees/detail': 'Chi tiết nhân viên', '/hr/contracts': 'Hợp đồng', '/hr/contracts/detail': 'Chi tiết hợp đồng',
