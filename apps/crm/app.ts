...
import { OdooDialog, type OdooDialogField } from '@core3/framework/components/OdooDialog.ts';
import { html } from '@core3/framework/html.ts';
import { OdooShell } from '@core3/framework/components/OdooShell.ts';
import { ActionRouter, ActionService, AppRegistry, ModuleMenuTree, NotificationCenter, UnsavedChangesGuard, type AppManifest } from '@core3/framework/services/index.ts';
