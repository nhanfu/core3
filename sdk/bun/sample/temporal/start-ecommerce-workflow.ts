...
const input: PaymentDeliveryInput = { order_id: orderId, payment_method: 'Wire Transfer', delivery_method: 'Standard Delivery', await_callbacks: process.env.TEMPORAL_AWAIT_CALLBACKS === 'true' };
