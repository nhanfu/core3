...
| 2026-09-12 | Forum | Website → Configuration → Forum → Forums list (forum_forum_action / forum_forum_view_tree) | pending | focused tests 4/4, 27 assertions; UI audit passed; ESLint and diff check passed | attempted; no visual claim | Odoo /forum 404; Core3 existing 3001 returned 401 and fresh frontend failed EMFILE; see forum.md |
