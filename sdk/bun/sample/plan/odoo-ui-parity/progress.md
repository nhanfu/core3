...
| 2026-09-12 | Time Off | Allocation list bulk Approve/Refuse actions | `ae7d6dee` | focused tests 2/2, 6 assertions; full Time Off 45 tests/485 assertions; UI audit, ESLint, and diff check passed | attempted 1440x900 and 390x844; no visual claim | Core3 Vite `EMFILE: too many open files`; Odoo login available but no authenticated reference session; see `time-off.md` |
