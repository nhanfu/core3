...
The requested authenticated Products, Shop, Product Detail, and Product
Variant captures at desktop (`1440x900`) and mobile (`390x844`) were attempted
through the local runtime probes. No Core3 HTTP listener was available:
`/api/modules` refused connections on ports 3000, 4312, and 4313 (HTTP 000
connection failures). No rendered compare-price pass or screenshot is claimed;
shared runtime/discovery files were not modified.
