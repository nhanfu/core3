...
The requested authenticated Product Detail and Product Variant capture at
desktop (`1440x900`) and mobile (`390x844`) was attempted through the local
runtime probe. No Core3 HTTP listener was available: `/api/modules` refused
connections on ports 3000, 4312, and 4313 (HTTP 000 connection failures). No
rendered base-unit pricing pass or screenshot is claimed; shared
runtime/discovery files were not modified.
