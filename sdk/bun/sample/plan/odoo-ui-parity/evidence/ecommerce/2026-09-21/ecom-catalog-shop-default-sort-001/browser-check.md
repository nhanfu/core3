...
- `http://127.0.0.1:3000/ecommerce/shop-default-sort` — HTTP 000,
  connection refused.
- `http://127.0.0.1:4312/ecommerce/shop-default-sort` — HTTP 000,
  connection refused.
- `http://127.0.0.1:4313/ecommerce/shop-default-sort` — HTTP 000,
  connection refused.

Authenticated Core3 desktop/mobile screenshots and rendered form/order checks
are blocked; no UI sign-off is claimed.
...
comparison. Odoo source/controller/template/builder comparison remains in
