...
- Transfer regression cases: `bun test test/inventory_transfer_workflow.integration.test.ts
  --test-name-pattern 'unreserves|returns realistic|enforces guarded'` — PASS,
