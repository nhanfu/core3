...
authenticated screenshots were fabricated. The bounded probes below are the
available runtime evidence.

## Core3

Both desktop and mobile Core3 capture paths are blocked because the runtime was
not listening:
...
The known Odoo Print/PDF/action-surface blockers remain open separately.
