# Surveys public Datetime question evidence

Feature: `SURVEYS-PUBLIC-DATETIME-QUESTION-001`

This bounded slice implements Odoo's public `datetime` question validation as
the Core3 `Datetime` variant. The page contract remains in
