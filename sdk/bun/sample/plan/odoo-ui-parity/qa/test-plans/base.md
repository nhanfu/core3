...
| BASE-FUNC-011 | functional/data/permission | Contact duplicate workflow | Duplicate from contact detail, copy fields/tags, persist after restart, and enforce write/company/active/stale/duplicate-ID guards | `test/base_contact_duplicate.integration.test.ts`; `evidence/base/2026-09-22/BASE-CONTACT-DUPLICATE-001` | pass at contract level; fresh Core3 visual blocked by bsk session loss |
| BASE-FUNC-012 | functional/data/permission | Contact child relation | Read the Contacts notebook child list, create/edit/delete related contacts, persist after restart, and enforce active-company, parent/child stale, duplicate, required, missing, and scope guards | `test/base_contact_children.integration.test.ts`; `evidence/base/2026-09-22/BASE-CONTACT-HIERARCHY-CHILDREN-001` | pass at contract level; Odoo/Core3 desktop/mobile visual blocked by borrowed bsk tab |
| BASE-FUNC-013 | functional/data/permission | Contact merge wizard | Select two or three same-company contacts, choose a destination, reparent Base-owned relations, delete sources, audit the merge, persist after restart, and reject hierarchy/email/scope/destination/stale violations | `test/base_contact_merge.integration.test.ts`; `evidence/base/2026-09-22/BASE-CONTACT-MERGE-001` | pass at contract level; BrowserSkill tab borrow blocker prevents Odoo/Core3 visual evidence |
