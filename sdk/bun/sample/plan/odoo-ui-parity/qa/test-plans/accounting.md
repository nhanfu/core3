...
| ACC-FUNC-009 | functional | Import/export/attachments/print | Exercise available import/export, attachment, report and print actions | browser interaction gate | planned |
