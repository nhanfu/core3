...
| TIMESHEET-PORTAL-TASK-REPORT-001 | Portal task Timesheets View Details records a durable task/actor/company-scoped report run, renders persisted lines, and rejects stale or unauthorized requests | pass: focused 4 tests / 32 expectations; related portal regression 22 tests / 174 expectations; Core3 authenticated capture blocked after BrowserSkill session closure |
