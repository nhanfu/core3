...
| ECOM-FUNC-005 | Empty/error/not-found | Empty, unavailable, missing, forbidden and transport-error states are explicit | pass at contract level |
| ECOM-FUNC-006 | Migrations/seeds | Reapply schema/demo fixtures idempotently without duplicate products, prices or orders | planned restart/migration gate |
| ECOM-FUNC-007 | Assets/import/export/print | Exercise product images/assets, catalog import/export and exposed print actions | planned browser interaction gate |
...
| --- | --- | --- | --- | --- |
| ECOM-UI-001 | Shop/product/pricelist | 1440x900, 390x844 | Catalog cards, product detail, prices, controls and responsive layout match Odoo | planned paired capture |
