...
| ECOMMERCE-WF-017 | Cart price-list recalculation | Same Cart test — applies the retail price list to the authenticated owned cart, persists `pricelist_id`, recalculates the chair line from 249 USD to 229 USD, and increments line versions | pass at service/API contract level; authenticated browser selection and paired Odoo comparison remain open |
