...
| ECOMMERCE-WF-015 | Authenticated add-to-cart lifecycle | Same Shop test — token-derived customer cart is selected, product line is persisted, and repeated add increments quantity | pass for add/repeat-add; remove and price recalculation remain open |
