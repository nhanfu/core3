...
file-backed restart checks pass when run without the unrelated shared-checkout
discovery boundary. Authenticated Core3 desktop/mobile evidence and paired
...
The shared `discoverPages()` audit is currently blocked by unrelated
Ecommerce/Employees/Surveys API edits, recorded in the feature verification
rather than attributed to Inventory. Full Inventory sign-off remains open.
