...
remain YAML-driven. Their rendered UI must still match Odoo; their bespoke Odoo
...
| website | website | available; YAML-driven | `odoo-ui-parity/website.md` | planned |
| ecommerce | website_sale | available; YAML-driven | `odoo-ui-parity/ecommerce.md` | planned |
| blog | website_blog | available; YAML-driven | `odoo-ui-parity/blog.md` | planned |
| forum | website_forum | available; YAML-driven | `odoo-ui-parity/forum.md` | planned |
