      ...
      if (component.views !== undefined) {
        if (!Array.isArray(component.views) || !component.views.length) {
          ...
          component.views.forEach((view, viewIndex) => {
            ...
            rejectUnknownKeys(view, new Set(['id', 'label', 'icon', 'group_by', 'group_total_field', 'group_progress_field', 'column_count', 'date_field', 'end_date_field', 'groups', 'groups_source', 'card', 'row_field', 'column_field', 'row_fields', 'column_fields', 'measure_field', 'measure_label', 'measures', 'aggregate', 'category_field', 'type', 'label_field', 'subtitle_field', 'latitude_field', 'longitude_field', 'pivot']), viewPath, issues);
